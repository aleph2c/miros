...
class ToasterOven(ActiveObject):
  ...
  def __init__(self, name, toast_time_in_sec=None, bake_time_in_sec=None, get_ready_sec=None, done_buzz_period_sec=None):
...
if __name__ == '__main__':
  ...
  oven = ToasterOvenMock(name="oven", toast_time_in_sec=1.0,
      bake_time_in_sec=2.0, get_ready_sec=0.10, done_buzz_period_sec=0.05)
  oven.live_spy = True
