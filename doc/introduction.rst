...
statecharts, you will have the ability to quickly translate your design goals
into working and robust code.

An HSM follows an intuitive set of rules called the Harel formalism.  This
formalism was invented by the mathematician, Dr. David Harel in the 1980s to
help the Israeli air force construct better software for their jet fighters.
...
used by the event processing engine; `Dr. Miro Samek`_.


.. note:: 

  In fact the whole miros library has been constructed to send some business his
  way.  He runs an embedded consulting company call Quantum Leaps.  If you write
  code using this library, it should be fairly straight forward to port it to
  c/C++ if you would like to transfer your design to his `QP framework`_ (for a
...
I have tried to document this project so that you can learn how to:
  ...
  * reflect upon the behavior or your state machines
  * create multiple statecharts that work together
  * to test your work
