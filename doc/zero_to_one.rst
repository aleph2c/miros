...
see that I use some reStructuredText in my Docstring which adds some clutter.  I
don't remember how to use reStructuredText; I have a snippet write it for me so
that I can follow a documentation convention.

When a docstring written in this manner is parsed and turned into html it will
produce a document that looks like `this
...
python uses something called the global interpreter lock.
